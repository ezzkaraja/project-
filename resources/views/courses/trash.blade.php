...
<body class="bg-gray-50 p-6"> <!-- الخلفية + مسافة من كل الحواف -->
  ...
  <div class="max-w-7xl mx-auto">
    ...
    {{-- button ubdate --}}
    <a href="{{ route('courses.restore',  $course->id) }}" class="inline-flex items-center justify-center w-8 h-8 bg-blue-500 text-white rounded hover:bg-blue-600 transition-colors ml-2">
